...
PROP_LINK = ":class:`~bokeh.core.properties.%s` "
MODEL_LINK = ":class:`~%s` "
...
class Property(PropertyFactory):
    ''' Base class for a description of a property, not associated yet with an
    attribute name or a class.'''
    ...
    def make_descriptors(self, base_name):
        return [ BasicPropertyDescriptor(property=self, name=base_name) ]
